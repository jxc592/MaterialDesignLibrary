package com.guoguang.dkjdcx.app;
 ...
 */
public class LoanProSearchApp  extends Application{
    ...
    public static void setmAidlClient(AidlClient mAidlClient) {
        LoanProSearchApp.mAidlClient = mAidlClient;
    }
    ...
    public static void setmLoginResponse(LoginResponse mLoginResponse) {
        LoanProSearchApp.mLoginResponse = mLoginResponse;
