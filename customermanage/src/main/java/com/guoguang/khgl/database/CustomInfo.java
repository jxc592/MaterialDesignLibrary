...
/**
 * Entity mapped to table CUSTOM_INFO.
 */
public class CustomInfo {
    ...
    public CustomInfo(Long id) {
        this.id = id;
    }

    public CustomInfo(Long id, String seqNo, String FullName, String CertType, String InsertTime, String UpdateTime, String CertID, String ManageUserName, String CusInfo) {
        this.id = id;
        this.seqNo = seqNo;
